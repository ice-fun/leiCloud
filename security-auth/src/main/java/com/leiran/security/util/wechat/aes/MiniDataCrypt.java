package com.leiran.security.util.wechat.aes;
...
public class MiniDataCrypt {
    ...
    public static WechatResponse miniDecrypt(String encryptedData, String encodingAesKey, String iv) throws AesException {
        ...
        try {
            ...
            if (null != original && original.length > 0) {
                ...
                return JSONUtils.parseObject(result, WechatResponse.class);
            }
        } catch (Exception e) {
            e.printStackTrace();
            throw new AesException(AesException.DecryptAESError);
